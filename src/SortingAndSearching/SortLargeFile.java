...
public class SortLargeFile {
	...
	public static void main(String[] args) throws Exception {
		...
		sort(PATH + "largedata.dat", PATH + "sortedfile.dat");

		// Display the first 100 numbers in the sorted file
		displayFile(PATH + "sortedfile.dat");
	}
	...
	public static void sort(String sourcefile, String targetfile) throws Exception {
		...
		int numberOfSegments = initializeSegments(MAX_ARRAY_SIZE, sourcefile, PATH + "f1.dat");

		// Implement Phase 2: Merge segments recursively
		merge(numberOfSegments, MAX_ARRAY_SIZE, PATH + "f1.dat", PATH + "f2.dat", PATH + "f3.dat", targetfile);
	}
